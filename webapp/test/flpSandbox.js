		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "직영점 조회",
									"targetURL": "#synceafindstore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceafindstore-display": {
								"semanticObject": "synceafindstore",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.findstore",
									"url": sap.ui.require.toUrl("sync/ea/findstore")
								}
							}
						}
					}
